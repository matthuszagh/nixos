...
The Emacs daemon starts up using a systemd script, \mintinline{text}{/usr/lib/systemd/user/emacs.service}. It's enabled
for a user with the command

\begin{minted}{text}
$ systemctl --user enable --now emacs
\end{minted}

Running this without superuser privileges is intentional.
