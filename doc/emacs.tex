...
\section{Fix org cycling for outline list}

<tab> should only show top-level of headline first, then sublevels, etc. See
\href{https://stackoverflow.com/questions/25492847/org-mode-source-block-visibility-cycling}{this
  answer} for how to do that.
